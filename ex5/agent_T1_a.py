...
class Policy(nn.Module):
    def __init__(self, state_dim, action_dim):
        ...
        # define log standard deviation
        self.actor_logstd = torch.tensor(np.zeros(action_dim), device=device)
...
class PG(object):
    ...
    def update(self,):
        ...
        loss = - torch.mean(disc_rewards * action_probs)
    ...
    def get_action(self, observation, evaluation=False):
        ...
        # get action distribution following policy for given observation
