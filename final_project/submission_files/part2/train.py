...
def main(cfg):
    ...
    print(cfg.tau, cfg.lr, cfg.hidden_dims, cfg.train_episodes, cfg.max_episode_steps, cfg.test_episodes, cfg.random_episodes, cfg.glie_b, cfg.gamma, cfg.batch_size, cfg.buffer_size)
